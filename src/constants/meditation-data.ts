...
export enum MeditationGroupName {
  ...
  'CountYourBlessings' = 'Count Your Blessings',
  'Custom' = 'Custom',
...
export const botecMap = {
  ...
  [BotecBaseKeys.MedBotec11]: {
    ...
    name: 'Blessings From the Brain - Blessing of the Energy Centers 11',
    type: MeditationTypes.Meditation,
    url: placeholder,
  },
};
...
export enum BreathBaseKeys {
  ...
  BreathInspireV2WarmthSun = 'b-inspire-v2-warmth-sun',
  BreathInspireV2Olorum = 'b-inspire-v2-olorum',
  BreathInspireV2RidingThrough = 'b-inspire-v2-riding-through',
  BreathInspireV2Merging = 'b-inspire-v2-merging',
  BreathInspireV2Overgrown = 'b-inspire-v2-overgrown',
  BreathInspireV2Moyayaj = 'b-inspire-v2-moyayaj',
  BreathInspireV2Inhalation = 'b-inspire-v2-inhalation',
  BreathInspireV2FireGathering = 'b-inspire-v2-fire-gathering',
  BreathInspireV2CosmicHeart = 'b-inspire-v2-cosmic-heart',
  BreathInspireV2PranaSoundscapes = 'b-inspire-v2-prana-soundscapes',
  BreathInspireV2ContinuousMix = 'b-inspire-v2-continuous-mix',
}
...
export enum BreathSizes {
  ...
  BreathInspireV2WarmthSun = 0,
  BreathInspireV2Olorum = 0,
  BreathInspireV2RidingThrough = 0,
  BreathInspireV2Merging = 0,
  BreathInspireV2Overgrown = 0,
  BreathInspireV2Moyayaj = 0,
  BreathInspireV2Inhalation = 0,
  BreathInspireV2FireGathering = 0,
  BreathInspireV2CosmicHeart = 0,
  BreathInspireV2PranaSoundscapes = 0,
  BreathInspireV2ContinuousMix = 0,
}
...
export const breathMap = {
  ...
  [BreathBaseKeys.BreathInspireV2ContinuousMix]: {
    ...
    name: 'Inspire V2 Continuous Breath Mix',
    type: MeditationTypes.Breath,
    url: placeholder,
  },
};
...
export enum WalkingBaseKeys {
  ...
  MedWalkingChangingBoxes = 'm-walking-changing-boxes',
}
...
export const walkingMap = {
  ...
  [WalkingBaseKeys.MedWalkingChangingBoxes]: {
    ...
    name: 'Changing Boxes Walking Meditation',
    type: MeditationTypes.Meditation,
    url: placeholder,
  },
};
...
export enum CountYourBlessingsBaseKeys {
  MedCountYourBlessings1 = 'm-count-your-blessings-1',
  MedCountYourBlessings2 = 'm-count-your-blessings-2',
  MedCountYourBlessings3 = 'm-count-your-blessings-3',
  MedCountYourBlessings4 = 'm-count-your-blessings-4',
  MedCountYourBlessings5 = 'm-count-your-blessings-5',
  MedCountYourBlessings6 = 'm-count-your-blessings-6',
  MedCountYourBlessings7 = 'm-count-your-blessings-7',
  MedCountYourBlessings8 = 'm-count-your-blessings-8',
}

export enum CountYourBlessingsSizes {
  MedCountYourBlessings1 = 0,
  MedCountYourBlessings2 = 0,
  MedCountYourBlessings3 = 0,
  MedCountYourBlessings4 = 0,
  MedCountYourBlessings5 = 0,
  MedCountYourBlessings6 = 0,
  MedCountYourBlessings7 = 0,
  MedCountYourBlessings8 = 0,
}

export enum CountYourBlessingsStringSizes {
  MedCountYourBlessings1 = '0',
  MedCountYourBlessings2 = '0',
  MedCountYourBlessings3 = '0',
  MedCountYourBlessings4 = '0',
...
export const countYourBlessingsMap = {
...
export enum OtherBaseKeys {
  ...
  MedOutpicturing = 'm-outpicturing',
  MedLifeLoveMystical = 'm-life-love-mystical',
  MedChangingBoxesLiveMeilan = 'm-changing-boxes-live-meilan',
  MedWholyDays = 'm-wholy-days',
  MedLoveYourBody = 'm-love-your-body',
  MedMorningMeditation = 'm-morning-meditation',
  MedEveningMeditation = 'm-evening-meditation',
}
...
export enum OtherSizes {
  ...
  MedOutpicturing = 0,
  MedLifeLoveMystical = 0,
  MedChangingBoxesLiveMeilan = 0,
  MedWholyDays = 0,
  MedLoveYourBody = 0,
  MedMorningMeditation = 0,
  MedEveningMeditation = 0,
}
...
export const otherMap = {
  ...
  [OtherBaseKeys.MedLifeLoveMystical]: {
    ...
    name: 'Life, Love, and the Mystical',
    type: MeditationTypes.Meditation,
    url: placeholder,
  },
  [OtherBaseKeys.MedChangingBoxesLiveMeilan]: {
    ...
    name: 'Changing Boxes - Short - Live with Mei-lan',
    type: MeditationTypes.Meditation,
    url: placeholder,
  },
