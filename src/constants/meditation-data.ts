...
export const walkingtMap = {
  ...
  [WalkingBaseKeys.MedWalkingPrayerEvocationInvocation2]: {
    artist,
    backgroundImage: require('../assets/wm-prayer-evo-invo.jpg'),
    formattedDuration: '75',
    id: placeholder,
    groupName: MeditationGroupName.Walking,
    meditationBaseId: WalkingBaseKeys.MedWalkingPrayerEvocationInvocation2,
    name: 'Walking Meditation 06 - Prayer of Evocation & Invocation',
    type: MeditationTypes.Meditation,
    url: placeholder,
  },
  [WalkingBaseKeys.MedWalkingPrayerEvocationInvocation3]: {
    artist,
    backgroundImage: require('../assets/wm-prayer-evo-invo.jpg'),
    formattedDuration: '75',
    id: placeholder,
    groupName: MeditationGroupName.Walking,
    meditationBaseId: WalkingBaseKeys.MedWalkingPrayerEvocationInvocation3,
    name: 'Walking Meditation 06 - Prayer of Evocation & Invocation',
    type: MeditationTypes.Meditation,
    url: placeholder,
  },
